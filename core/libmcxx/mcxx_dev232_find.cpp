 ...
 * @brief s3::mcxx_dev232_find_device_tインスタンスを初期化します。
 * @param self_p s3::mcxx_dev232_find_device_tインスタンスポインタ
 * @retval 0 成功
 ...
 * @brief s3::mcxx_dev232_find_device_tインスタンスのデバイス検索位置を先頭に移動します
 * @param self_p s3::mcxx_dev232_find_device_tインスタンスポインタ
 * @retval 0 成功
 * @retval それ以外 エラーだけと未定義
 */
 ...
 * @brief s3::mcxx_dev232_find_device_tインスタンスを破棄します。
 */
