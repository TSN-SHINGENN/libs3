...
extern int mpxx_stl_vector_init( mpxx_stl_vector_t *const, const size_t)
		__attribute__ ((optimize("Os")));
extern int mpxx_stl_vector_init_ex( mpxx_stl_vector_t *const, const size_t, mpxx_stl_vector_attr_t *const)
		__attribute__ ((optimize("Os")));
extern int mpxx_stl_vector_attach_memory_fixed( mpxx_stl_vector_t *const, void *const, const size_t)
		__attribute__ ((optimize("Os")));

extern int mpxx_stl_vector_destroy( mpxx_stl_vector_t *const)
		__attribute__ ((optimize("Os")));

extern int mpxx_stl_vector_push_back( mpxx_stl_vector_t *const, const void *const, const size_t)
		__attribute__ ((optimize("Os")));
extern int mpxx_stl_vector_pop_back( mpxx_stl_vector_t *const)
		__attribute__ ((optimize("Os")));

extern int mpxx_stl_vector_resize( mpxx_stl_vector_t *const, const size_t, const void *const, const size_t)
		__attribute__ ((optimize("Os")));
extern int mpxx_stl_vector_reserve( mpxx_stl_vector_t *const, const size_t)
		__attribute__ ((optimize("Os")));
extern int mpxx_stl_vector_clear( mpxx_stl_vector_t *const)
		__attribute__ ((optimize("Os")));

extern size_t mpxx_stl_vector_capacity( mpxx_stl_vector_t *const)
		__attribute__ ((optimize("Os")));
extern void *mpxx_stl_vector_ptr_at( mpxx_stl_vector_t *const, const size_t)
		__attribute__ ((optimize("Os")));
extern int mpxx_stl_vector_is_empty( mpxx_stl_vector_t *const)
		__attribute__ ((optimize("Os")));

extern size_t mpxx_stl_vector_size( mpxx_stl_vector_t *const)
		__attribute__ ((optimize("Os")));
extern size_t mpxx_stl_vector_get_pool_cnt( mpxx_stl_vector_t *const)
		__attribute__ ((optimize("Os")));

extern int mpxx_stl_vector_front( mpxx_stl_vector_t *const, void *const, const size_t)
		__attribute__ ((optimize("Os")));
extern int mpxx_stl_vector_back( mpxx_stl_vector_t *const, void *const, const size_t)
		__attribute__ ((optimize("Os")));

extern int mpxx_stl_vector_insert( mpxx_stl_vector_t *const, const size_t, const void *const, const size_t)
		__attribute__ ((optimize("Os")));

extern int mpxx_stl_vector_remove_at( mpxx_stl_vector_t *const, const size_t)
		__attribute__ ((optimize("Os")));

extern int mpxx_stl_vector_get_element_at( mpxx_stl_vector_t *const, const size_t, void *const, const size_t)
		__attribute__ ((optimize("Os")));
extern int mpxx_stl_vector_overwrite_element_at( mpxx_stl_vector_t *const, const size_t, const void *const, const size_t)
		__attribute__ ((optimize("Os")));

extern int mpxx_stl_vector_element_swap_at( mpxx_stl_vector_t *const, const size_t, const size_t)
		__attribute__ ((optimize("Os")));

extern int mpxx_stl_vector_shrink( mpxx_stl_vector_t *const, const size_t)
		__attribute__ ((optimize("Os")));
...
/**
 * @fn int mpxx_stl_vector_init( mpxx_stl_vector_t *const self_p, const size_t sizof_element)
 * @brief vectorオブジェクトを初期化します。
 * @param self_p mpxx_stl_vector_t構造体インスタンスポインタ
...
{
    return mpxx_stl_vector_init_ex(self_p, sizof_element, NULL);
}

/**
 * @fn int mpxx_stl_vector_init_ex( mpxx_stl_vector_t *const self_p, const size_t sizof_element, mpxx_stl_vector_attr_t *const attr_p)
 * @brief vectorオブジェクトを初期化します。
 * @param self_p mpxx_stl_vector_t構造体インスタンスポインタ
 * @param sizof_element 要素サイズ
 * @param attr_pi mpxx_stl_vector_attr_t構造体ポインタ設定値
 * @retval 0 成功
 * @retval EAGAIN リソース獲得に失敗
 * @retval EINVAL 引数が不正
 * @retval -1 エラー定義以外の致命的な失敗
...
int mpxx_stl_vector_init_ex( mpxx_stl_vector_t *const self_p, const size_t sizof_element, mpxx_stl_vector_attr_t *const attr_p)
{
    ...
    memset(self_p, 0x0, sizeof(mpxx_stl_vector_t));

    e = (stl_vector_ext_t *)
	mpxx_malloc(sizeof(stl_vector_ext_t));
    if (NULL == e) {
	DBMS1(stderr, "mpxx_stl_vector_init_ex : mpxx_malloc(ext) fail" EOL_CRLF);
	return EAGAIN;
    }
...
/**
 * @fn int mpxx_stl_vector_destroy(mpxx_stl_vector_t *const self_p)
			 ...
			 const size_t num_elements, const void *const el_p)
{
	...
	mpxx_u64toadec( (uint64_t)e->reserved_bytes, xtoa_buf_a, xtoa_bufsz);
	mpxx_u64toadec( (uint64_t)new_reserve, xtoa_buf_b, xtoa_bufsz);
	DBMS3(stderr, "mpxx_stl_vector:resize_buffer: execute" EOL_CRLF);
        DBMS3(stderr,
	  "mpxx_stl_vector:resize_buffer: reserved=%s new_reserved=%s" EOL_CRLF,
	...
	char xtoa_buf_a[MPXX_XTOA_DEC64_BUFSZ];
	char xtoa_buf_b[MPXX_XTOA_DEC64_BUFSZ];
	mpxx_u64toadec( (uint64_t)e->num_elements, xtoa_buf_a, xtoa_bufsz);
	mpxx_u64toadec( (uint64_t)num_elements, xtoa_buf_b, xtoa_bufsz);
	DBMS3(stderr,
	  "mpxx_stl_vector:resize_buffer e->num_elements=%s num_elements=%s" EOL_CRLF,
	  xtoa_buf_a, xtoa_buf_b);
    }
	...
	if (NULL != el_p) {
		...
		IFDBG3THEN {
		    ...
		    mpxx_u64toadec( (uint64_t)st_pos, xtoa_buf_a, xtoa_bufsz);
		    mpxx_u64toadec( (uint64_t)end_pos, xtoa_buf_b, xtoa_bufsz);
		    mpxx_u64toadec( (uint64_t)e->sizof_element, xtoa_buf_c, xtoa_bufsz);
		    DBMS3(stderr,
		      "mpxx_stl_vector:resize_buffer st=%s en=%s sizof_element=%s" EOL_CRLF,
		      xtoa_buf_a, xtoa_buf_b, xtoa_buf_c);
		}
		for (n = st_pos; n < end_pos; n++) {
		    void *at =
			(uint8_t *) e->buf + (n * e->sizof_element);
		    mpxx_memcpy(at, el_p, e->sizof_element);
		}
		...
		IFDBG3THEN {
		    ...
		    mpxx_u64toadec( (uint64_t)st_pos, xtoa_buf_a, xtoa_bufsz);
		    mpxx_u64toadec( (uint64_t)dur, xtoa_buf_b, xtoa_bufsz);
		    mpxx_u64toadec( (uint64_t) *(uint8_t *) el_p, xtoa_buf_c, xtoa_bufsz);
		    DBMS3(stderr,
		      "mpxx_stl_vector:resize_buffer(Byte) st=%s dur=%s d=%s" EOL_CRLF,
		      xtoa_buf_a, xtoa_buf_b, xtoa_buf_c);
		}
...
/**
 * @fn int mpxx_stl_vector_push_back( mpxx_stl_vector_t *const self_p, const void *const el_p, const size_t sizof_element)
 * @brief 末尾に要素を追加します
 ...
 * @retval EINVAL 引数不正
 */
int mpxx_stl_vector_push_back(mpxx_stl_vector_t *const self_p,
				 ...
				 const size_t sizof_element)
{
    ...
    DBMS3(stderr, "mpxx_stl_vector_push_back : execute" EOL_CRLF);
	...
	mpxx_u64toadec( (uint64_t)e->num_elements, xtoa_buf, xtoa_bufsz);
	DBMS3(stderr,
	  "mpxx_stl_vector_push_back : e->num_elements=%s, add" EOL_CRLF,
	    xtoa_buf);
    }
...
/**
 * @fn int mpxx_stl_vector_pop_back( mpxx_stl_vector_t *const self_p)
 * @brief 末尾の要素を削除します
 * @param self_p mpxx_stl_vector_t構造体インスタンスポインタ
 * @retval 0 成功
...
/**
 * @fn int mpxx_stl_vector_resize( mpxx_stl_vector_t *const self_p, const size_t num_elements, const void *const el_p, const size_t sizof_element)
 ...
 */
int mpxx_stl_vector_resize(mpxx_stl_vector_t *const self_p,
			      const size_t num_elements, const void *const el_p,
			      const size_t sizof_element)
{
    stl_vector_ext_t *const e =
...
/**
 * @fn int mpxx_stl_vector_reserve( mpxx_stl_vector_t *const self_p, const size_t num_elements);
 ...
 */
int mpxx_stl_vector_reserve(mpxx_stl_vector_t *const self_p,
...
/**
 * @fn size_t mpxx_stl_vector_capacity( mpxx_stl_vector_t *const self_p)
...
/**
 * @fn void *mpxx_stl_vector_ptr_at(mpxx_stl_vector_t *const self_p, const size_t num)
 * @brief 要素の割当ポインタを得る
...
/**
 * @fn int mpxx_stl_vector_is_empty(mpxx_stl_vector_t *const self_p)
...
/**
 * @fn size_t mpxx_stl_vector_size(mpxx_stl_vector_t *const  self_p)
...
/**
 * @fn int mpxx_stl_vector_clear(mpxx_stl_vector_t *const self_p)
...
/**
 * @fn size_t mpxx_stl_vector_get_pool_cnt( mpxx_stl_vector_t *const self_p)
...
/**
 * @fn int mpxx_stl_vector_front( mpxx_stl_vector_t *const self_p, void *const el_p, const size_t sizof_element)
...
int mpxx_stl_vector_front( mpxx_stl_vector_t *const self_p, void *const el_p, const size_t sizof_element)
{
    ...
    mpxx_memcpy( el_p, e->buf, e->sizof_element);

    return 0;
}

/**
 * @fn int mpxx_stl_vector_back( mpxx_stl_vector_t *const self_p, void *const el_p, const size_t sizof_element)
...
int mpxx_stl_vector_back( mpxx_stl_vector_t *const self_p, void *const el_p, const size_t sizof_element)
{
    ...
    mpxx_memcpy( el_p, (uint8_t*)e->buf + (e->sizof_element * (e->num_elements -1)), e->sizof_element);

    return 0;
}

/**
 * @fn int mpxx_stl_vector_insert( mpxx_stl_vector_t *const self_p, const size_t num, const void *const el_p, const size_t sizof_element)
 * @brief 要素を挿入します。
 * @param self_p mpxx_stl_vector_t構造体インスタンスポインタ
 * @param num 要素番号
...
int mpxx_stl_vector_insert( mpxx_stl_vector_t *const self_p, const size_t num, const void *const el_p, const size_t sizof_element)
{
    ...
    if(result) {
	DBMS1( stderr, "mpxx_stl_vector_insert : resize_buffer fail, strerror:%s" EOL_CRLF, strerror(result));
	return result;
    }
    ...
    mpxx_memcpy( ptr, el_p, e->sizof_element);
    ++(e->num_elements);
...
/**
 * @fn int mpxx_stl_vector_remove_at( mpxx_stl_vector_t *const self_p, const size_t num)
 * @brief 要素を消去します。
 * 	*** 検証中です ***
 * @param self_p mpxx_stl_vector_t構造体インスタンスポインタ
 * @param num 要素番号
...
/**
 * @fn int mpxx_stl_vector_get_element_at( mpxx_stl_vector_t *const self_p, const size_t num, void *const el_p, const size_t sizof_element)
 * @brief 保存された要素を返します
 * @param self_p mpxx_stl_vector_t構造体インスタンスポインタ
...
int mpxx_stl_vector_get_element_at( mpxx_stl_vector_t *const self_p, const size_t num, void *const el_p, const size_t sizof_element)
{
    stl_vector_ext_t *const e =
	get_vector_ext(self_p);
    const uint8_t *const ptr = MPXX_STATIC_CAST(const uint8_t*,mpxx_stl_vector_ptr_at(self_p, num));
    ...
    mpxx_memcpy( el_p, ptr, sizof_element);
...
/**
 * @fn int mpxx_stl_vector_overwrite_element_at( mpxx_stl_vector_t *const self_p, const size_t num, const void *const el_p, const size_t sizof_element)
 * @brief 保存された要素を返します
 * @param self_p mpxx_stl_vector_t構造体インスタンスポインタ
 * @param num 0空始まるキュー先頭からのエレメント配列番号
 * @param el_p エレメントデータコピー用エレメント構造体ポインタ
...
int mpxx_stl_vector_overwrite_element_at( mpxx_stl_vector_t *const self_p, const size_t num, const void *const el_p, const size_t sizof_element)
{
    stl_vector_ext_t *const e =
	get_vector_ext(self_p);
    uint8_t *const ptr = MPXX_STATIC_CAST(uint8_t*,mpxx_stl_vector_ptr_at(self_p, num));
    ...
    mpxx_memcpy( ptr, el_p, sizof_element);
...
/**
 * @fn int mpxx_stl_vector_element_swap_at( mpxx_stl_vector_t *const self_p, const size_t at1, const size_t at2)
...
int mpxx_stl_vector_element_swap_at( mpxx_stl_vector_t *const self_p, const size_t at1, const size_t at2)
{
    stl_vector_ext_t *const e =
	get_vector_ext(self_p);
    void *ptr1 = mpxx_stl_vector_ptr_at(self_p, at1);
    void *ptr2 = mpxx_stl_vector_ptr_at(self_p, at2);
    void *buf;
    ...
    buf = mpxx_malloc( e->sizof_element );
    if( NULL == buf ) {
	return EAGAIN;
    }
    mpxx_memcpy( buf, ptr1, e->sizof_element);
    mpxx_memcpy( ptr1, ptr2, e->sizof_element);
    mpxx_memcpy( ptr2, buf, e->sizof_element);
...
/**
 * @fn int mpxx_stl_vector_shrink( mpxx_stl_vector_t *const self_p, const size_t num_elements)
...
/**
 * @fn int mpxx_stl_vector_attach_memory_fixed( mpxx_stl_vector_t *const self_p, void *const mem_ptr, const size_t len)
 ...
 *  EPERMをエラーコードで戻します。 
 * ・mpxx_stl_vector_attach_memory_fixed()
 * ・mpxx_stl_vector_resize()
 * ・mpxx_stl_vector_reserve()
 * ・mpxx_stl_vector_shrink()
 * 次の関数は成功しますが、指定されたメモリを開放することはしません。
 * ・mpxx_stl_vector_clear()
 * 
 * @param self_p mpxx_stl_vector_t構造体インスタンスポインタ
...
int mpxx_stl_vector_attach_memory_fixed( mpxx_stl_vector_t *const self_p, void *const mem_ptr, const size_t len)
{
    ...
    // mbmcs_printf("mpxx_stl_vector_attach_memory_fixed : e->reserved_bytes = %u" EOL_CRLF, (unsigned int)e->reserved_bytes);
