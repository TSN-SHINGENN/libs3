...
extern char *mpxx_signed_to_string( const int64_t value, char * const buf, size_t bufsz, const uint8_t radix, const mpxx_xtoa_attr_t * const attr_p)
    __attribute__ ((optimize("Os")));
extern char *mpxx_unsigned_to_string( const uint64_t value, char * const buf, const size_t bufsz, const uint8_t radix, const mpxx_xtoa_attr_t *const attr_p)
    __attribute__ ((optimize("Os")));
extern int mpxx_integer_to_string_with_format(const mpxx_xtoa_output_method_t *const method_p, char sign, unsigned long long value, const int radix, int field_length, const mpxx_xtoa_attr_t *const attr_p, int *const retlen_p)
    __attribute__ ((optimize("Os")));

extern int mpxx_rand(void)
    __attribute__ ((optimize("Os")));
extern void mpxx_srand(const unsigned int)
    __attribute__ ((optimize("Os")));
...
/**
 * @fn int mpxx_atoi( const char * const str)
...
/**
 * @fn int32_t mpxx_atoi32( const char * const str)
...
int32_t mpxx_atoi32( const char * const str)
{
    const char *decimal_str;
    const int8_t decimal_is_minus = sign_is_minus( str, &decimal_str);
    uint32_t tmp = mpxx_atou32(decimal_str);
...
/**
 * @fn int64_t mpxx_atoi64( const char * const str);
...
int64_t mpxx_atoi64( const char * const str)
{
    ...
    uint64_t tmp = mpxx_atou64(decimal_str);
...
/**
 * @fn uint32_t mpxx_atou32( const char * const str)
...
/**
 * @fn uint32_t mpxx_atox32( const char *str )
...
/**
 * @fn uint64_t mpxx_atoo32( const char *str )
...
/**
 * @fn uint64_t mpxx_atoo64( const char *str )
 * @brief 32ビット換算の8進文字列を数値に変換します。前置詞の0oは無視します。
 *	大文字・小文字は問いません。
 *	エラーの場合は0を戻し、errnoにERANGEを設定します。
 * @param str 変換する文字列
...
static char *own_utoa( const uint64_t value, char *const buf, const size_t bufsz, const uint8_t radix, const mpxx_xtoa_attr_t *attr_p);
static char *own_itoa( const int64_t value, char *const buf, const size_t bufsz, const uint8_t radix, const mpxx_xtoa_attr_t *attr_p);
...
/** 
 * @fn static char *own_utoa( const uint64_t value, char * const buf, const size_t bufsz, const uint8_t radix, const mpxx_xtoa_attr_t *attr_p)
 * @brief value値をradixで指定された文字列に変換します。
 * @param value 変換値
 * @param buf 変換した文字列を格納するバッファ(マルチスレッド対策)
 * @param bufsize バッファサイズ
 * @param radix 基数値(2- )
 * @retval attr_p mpxx_xtoa_attr_t属性ポインタ（NULLでデフォルト)
...
static char *own_utoa( const uint64_t value, char * const buf, const size_t bufsz, const uint8_t radix, const mpxx_xtoa_attr_t *attr_p)
{
    const mpxx_xtoa_output_method_t o =  mpxx_xtoa_output_method_initializer_set_buffer( buf, bufsz);
    const mpxx_xtoa_attr_t attr = {0};
    ...
    reterr = mpxx_integer_to_string_with_format(&o, 0, (unsigned long long)value, radix, field_length, &attr, &retlen);
...
/** 
 * @fn static char *own_itoa( const int64_t value, char * const buf, size_t bufsz, const uint8_t radix, const mpxx_xtoa_attr_t *attr_p)
 ...
 **/
#if 0
static char *own_itoa( const int64_t i64v, char * const buf, size_t bufsz, const uint8_t radix, const mpxx_xtoa_attr_t * const attr_p)
{
    char *p = (char*)buf;
    uint64_t abs_value;
...
#else
static char *own_itoa( const int64_t i64v, char * const buf, const size_t bufsz, const uint8_t radix, const mpxx_xtoa_attr_t *attr_p)
{
    const mpxx_xtoa_output_method_t o =  mpxx_xtoa_output_method_initializer_set_buffer( buf, bufsz);
    const mpxx_xtoa_attr_t attr = {0};
    const int field_length = 0;
    ...
    reterr = mpxx_integer_to_string_with_format(&o, sign, (unsigned long long)abs_value, radix, field_length, &attr, &retlen);
...
/** 
 * @fn char *mpxx_i32toa( const int32_t value, void * const buf, const size_t bufsz, const uint8_t radix, const mpxx_xtoa_attr_t *attr_p)
 * @brief value値をradixで指定された文字列に変換します。マイナス値は基数に関係なく先頭に'-'を付けます。
 * @param value 変換値
 * @param buf 変換した文字列を格納するバッファ(マルチスレッド対策)
 * @param bufsize バッファサイズ
...
/** 
 * @fn char *mpxx_i64toa( const int64_t value, void * const buf, const size_t bufsz, const uint8_t radix, const mpxx_xtoa_attr_t *attr_p)
 * @brief value値をradixで指定された文字列に変換します。マイナス値は基数に関係なく先頭に'-'を付けます。
 * @param value 変換値
 * @param buf 変換した文字列を格納するバッファ(マルチスレッド対策)
 * @param bufsize バッファサイズ
...
/** 
 * @fn char *mpxx_u32toa( const uint32_t value, void * const buf, const size_t bufsz, const uint8_t radix, const mpxx_xtoa_attr_t *attr_p)
 * @brief value値をradixで指定された文字列に変換します。
 * @param value 変換値
 * @param buf 変換した文字列を格納するバッファ(マルチスレッド対策)
 * @param bufsize バッファサイズ
...
/** 
 * @fn char *mpxx_u64toa( const uint64_t value, void * const buf, const size_t bufsz, const uint8_t radix, const mpxx_xtoa_attr_t *attr_p)
 * @brief value値をradixで指定された文字列に変換します。
 * @param value 変換値
 * @param buf 変換した文字列を格納するバッファ(マルチスレッド対策)
 * @param bufsize バッファサイズ
...
/** 
 * @fn char *mpxx_u32toahex( const uint32_t value, void * const buf, const size_t bufsz, const mpxx_xtoa_attr_t *attr_p)
...
{
    return mpxx_u32toa( value, buf, bufsz, MPXX_XTOA_RADIX_HEX, attr_p);
}

/** 
 * @fn char *mpxx_u64toahex( const uint64_t value, void * const buf, const size_t bufsz, const mpxx_xtoa_attr_t * const attr_p)
 * @brief value値を符号なし16進文字列に変換します。
 * @param value 変換値
 * @param buf 変換した文字列を格納するバッファ(マルチスレッド対策)
 * @param bufsz バッファサイズ
...
{
    return mpxx_u64toa( value, buf, bufsz, MPXX_XTOA_RADIX_HEX, attr_p);
}


/** 
 * @fn char *mpxx_u64toadec( const uint64_t value, void * const buf, const size_t bufsz)
...
{
    return mpxx_u64toa( value, buf, bufsz, MPXX_XTOA_RADIX_DEC, NULL);
}


/** 
 * @fn char *mpxx_u32toadec( const uint32_t value, void * const buf, const size_t bufsz)
 * @brief value値を符号なし10進文字列に変換します。
 * @param value 変換値
 * @param buf 変換した文字列を格納するバッファ(マルチスレッド対策)
 * @param bufsz バッファサイズ
...
{
    return mpxx_u32toa( value, buf, bufsz, MPXX_XTOA_RADIX_DEC, NULL);
}


/** 
 * @fn char *mpxx_i64toadec( const int64_t value, void * const buf, const size_t bufsz)
...
{
    return mpxx_i64toa( value, buf, bufsz, MPXX_XTOA_RADIX_DEC, NULL);
}


/** 
 * @fn char *mpxx_i32toadec( const int32_t value, void * const buf, const size_t bufsz)
 * @brief value値を符号あり10進文字列に変換します。
 * @param value 変換値
 * @param buf 変換した文字列を格納するバッファ(マルチスレッド対策)
 * @param bufsz バッファサイズ
...
{
    return mpxx_i32toa( value, buf, bufsz, MPXX_XTOA_RADIX_DEC, NULL);
}

/** 
 * @fn char *mpxx_u64toabin( const uint64_t value, void * const buf, const size_t bufsz)
...
{
    return mpxx_u64toa( value, buf, bufsz, MPXX_XTOA_RADIX_BIN, NULL);
}

/** 
 * @fn char *mpxx_u32toabin( const uint32_t value, void * const buf, const size_t bufsz)
 * @brief value値を符号なし2進文字列に変換します。
 * @param value 変換値
 * @param buf 変換した文字列を格納するバッファ(マルチスレッド対策)
 * @param bufsz バッファサイズ
...
{
    return mpxx_u32toa( value, buf, bufsz, MPXX_XTOA_RADIX_BIN, NULL);
}

/**
 * @fn int mpxx_integer_to_string_with_format(mpxx_xtoa_output_method_t method_p, char sign, unsigned long long value, const int radix, int length, const mpxx_xtoa_attr_t *const opts_p, const int szoflimit, int *retlen_p)
...
int mpxx_integer_to_string_with_format(const mpxx_xtoa_output_method_t *const method_p, char sign, unsigned long long value, const int radix, int field_length, const mpxx_xtoa_attr_t *const attr_p, int *const retlen_p)
{
    ...
    char pad = ' ';
    int strpoint = 0;
    char stack_buf[MPXX_XTOA_BIN64_BUFSZ];
...
/**
 * @fn int mpxx_rand(void)
 * @brief ANSI/ISO/IEC C/ POSIXに対応する乱数発生を行う
 * @retval乱数値
 */
int mpxx_rand(void)
{
    return mpxx_rand_ansi();
}

/** 
 * @fn void mpxx_srand(const unsigned int seed)
 * @brief mpxx_rand()が使用する、新しい種を設定する
 * @param 新しい種
 */
 void mpxx_srand(const unsigned int seed)
{
    mpxx_rand_ansi_set_seed(seed);
    return;
}
