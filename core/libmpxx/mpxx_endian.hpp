...
static __inline void mpxx_set_be_d64( void * const p, const uint64_t d)
{
#if defined(QNX)
...
/**
 * @def MPXX_SET_BE_D64(p, d)
 * @brief 64-bitパック変数dをのプラットフォーム固有エンディアン形式からビックエンディアンに変換してポインタpに展開します
 */
#define MPXX_SET_BE_D64(p, d) mpxx_set_be_d64(p , d)

static __inline uint64_t mpxx_get_be_d64(const void * const p)
{
    uint64_t u64;
#if defined(QNX)
...
/**
 * @def MPXX_GET_BE_D64(p)
 * @brief ポインタpに示された64-bitパックのビックエンディアン値をプラットフォーム固有の形式に展開して返します。
 */
#define MPXX_GET_BE_D64(p) mpxx_get_be_d64(p)

static __inline void mpxx_set_le_d64(void * const p, const uint64_t d)
{
#if defined(QNX)
...
/**
 * @def MPXX_SET_LE_D64(p, d)
 * @brief 64-bitパック変数dをのプラットフォーム固有エンディアン形式からリトルエンディアンにポインタpに展開します
 */
#define MPXX_SET_LE_D64(p, d) mpxx_set_le_d64( p, d)

static __inline uint64_t mpxx_get_le_d64(const void * const p)
{
    uint64_t u64;
#if defined(QNX)
...
/**
 * @def MPXX_GET_LE_D64(p)
 * @brief ポインタpに示された64-bitパックのリトルエンディアン値をプラットフォーム固有の形式に展開して返します。
 */
#define MPXX_GET_LE_D64(p) mpxx_get_le_d64(p)

static __inline void mpxx_set_be_d56( void * const p, const uint64_t d)
{
...
/**
 * @def MPXX_SET_BE_D56(p, d)
 * @brief 56-bitパック変数dをのプラットフォーム固有エンディアン形式からビックエンディアンに変換してポインタpに展開します
 */
#define MPXX_SET_BE_D56(p, d) mpxx_set_be_d56(p , d)

static __inline uint64_t mpxx_get_be_d56(const void * const p)
{
    uint64_t u64;
...
/**
 * @def MPXX_GET_BE_D56(p)
 * @brief ポインタpに示された56-bitパックのビックエンディアン値をプラットフォーム固有の形式に展開して返します。
 */
#define MPXX_GET_BE_D56(p) mpxx_get_be_d56(p)

static __inline void mpxx_set_le_d56(void * const p, const uint64_t d)
{
    *((uint8_t*)p +  6) = (uint8_t)((d >> (8*6)) & 0xff);
    *((uint8_t*)p +  5) = (uint8_t)((d >> (8*5)) & 0xff);
    *((uint8_t*)p +  4) = (uint8_t)((d >> (8*4)) & 0xff);
...
/**
 * @def MPXX_SET_LE_D56(p, d)
 * @brief 56-bitパック変数dをのプラットフォーム固有エンディアン形式からリトルエンディアンにポインタpに展開します
 */
#define MPXX_SET_LE_D56(p, d) mpxx_set_le_d56( p, d)

static __inline uint64_t mpxx_get_le_d56(const void * const p)
{
    uint64_t u64;
...
/**
 * @def MPXX_GET_LE_D56(p)
 * @brief ポインタpに示された56-bitパックのリトルエンディアン値をプラットフォーム固有の形式に展開して返します。
 */
#define MPXX_GET_LE_D56(p) mpxx_get_le_d56(p)


static __inline void mpxx_set_be_d48( void * const p, const uint64_t d)
{
...
/**
 * @def MPXX_SET_BE_D48(p, d)
 * @brief 48-bitパック変数dをのプラットフォーム固有エンディアン形式からビックエンディアンに変換してポインタpに展開します
 */
#define MPXX_SET_BE_D48(p, d) mpxx_set_be_d48(p , d)

static __inline uint64_t mpxx_get_be_d48(const void * const p)
{
    uint64_t u64;
...
/**
 * @def MPXX_GET_BE_D48(p)
 * @brief ポインタpに示された48-bitパックのビックエンディアン値をプラットフォーム固有の形式に展開して返します。
 */
#define MPXX_GET_BE_D48(p) mpxx_get_be_d48(p)

static __inline void mpxx_set_le_d48(void * const p, const uint64_t d)
{
    *((uint8_t*)p +  5) = (uint8_t)((d >> (8*5)) & 0xff);
    *((uint8_t*)p +  4) = (uint8_t)((d >> (8*4)) & 0xff);
    *((uint8_t*)p +  3) = (uint8_t)((d >> (8*3)) & 0xff);
...
/**
 * @def MPXX_SET_LE_D48(p, d)
 * @brief 48-bitパック変数dをのプラットフォーム固有エンディアン形式からリトルエンディアンにポインタpに展開します
 */
#define MPXX_SET_LE_D48(p, d) mpxx_set_le_d48( p, d)

static __inline uint64_t mpxx_get_le_d48(const void * const p)
{
    uint64_t u64;
...
/**
 * @def MPXX_GET_LE_D48(p)
 * @brief ポインタpに示された48-bitパックのリトルエンディアン値をプラットフォーム固有の形式に展開して返します。
 */
#define MPXX_GET_LE_D48(p) mpxx_get_le_d48(p)

static __inline void mpxx_set_be_d32( void * const p, const uint32_t d)
{
#if defined(QNX)
...
/**
 * @def MPXX_SET_BE_D32(p, d)
 * @brief 32-bitパック変数dをのプラットフォーム固有エンディアン形式からビックエンディアンに変換してポインタpに展開します
 */
#define MPXX_SET_BE_D32(p, d) mpxx_set_be_d32(p , d)

static __inline uint32_t mpxx_get_be_d32(const void * const p)
{
    uint32_t u32;
#if defined(QNX)
...
/**
 * @def MPXX_GET_BE_D32(p)
 * @brief ポインタpに示された32-bitパックのビックエンディアン値をプラットフォーム固有の形式に展開して返します。
 */
#define MPXX_GET_BE_D32(p) mpxx_get_be_d32(p)

static __inline void mpxx_set_le_d32( void *p, const uint32_t d)
{
#if defined(QNX)
...
/**
 * @def MPXX_SET_LE_D32(p, d)
 * @brief 32-bitパック変数dをのプラットフォーム固有エンディアン形式からリトルエンディアン形式に変換してポインタpに展開します
 */
#define MPXX_SET_LE_D32(p, d) mpxx_set_le_d32(p, d)

static __inline uint32_t mpxx_get_le_d32(const void * const p)
{
    uint32_t r32;
...
static __inline void mpxx_set_be_d16( void * const p, const uint16_t d)
{
#if defined(QNX)
...
/**
 * @def MPXX_SET_BE_D16(p, d)
 * @brief 16-bitパック変数dをのプラットフォーム固有エンディアン形式からビックエンディアン形式に変換してポインタpに展開します
 */
#define MPXX_SET_BE_D16(p, d) mpxx_set_be_d16( p, d)


static __inline void mpxx_set_le_d16( void * const p, const uint32_t d)
{
#if defined(QNX)
...
/**
 * @def MPXX_SET_LE_D16(p, d)
 * @brief 16-bitパック変数dをのプラットフォーム固有エンディアン形式からリトルエンディアン形式に変換してポインタpに展開します
 */
#define MPXX_SET_LE_D16(p, d) mpxx_set_le_d16( p, d)

static __inline uint16_t mpxx_get_be_d16(const void * const p)
{
    uint16_t u16;
...
/**
 * @def MPXX_GET_BE_D16(p)
 * @brief ポインタpに示された16-bitパックのビックエンディアン値をプラットフォーム固有の形式に展開して返します。
 */
#define MPXX_GET_BE_D16(p) mpxx_get_be_d16(p)

static __inline uint16_t mpxx_get_le_d16(const void * const p)
{
    uint16_t u16;
#if defined(QNX)
...
/**
 * @def MPXX_GET_LE_D16(p)
 * @brief ポインタpに示された16-bitパックのリトルエンディアン値をプラットフォーム固有の形式に展開して返します。
 */
#define MPXX_GET_LE_D16(p) mpxx_get_le_d16(p)

#endif /* end of INC_MPXX_ENDIAN */
