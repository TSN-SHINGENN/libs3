 ...
 * @return mpxx_rand_xorshift_t構造体初期値
 */
 ...
 * @brief ANSI/ISO/IEC C規格の乱数発生処理本体。大きさはMPXX_RAND_ANSI_MAX以下
 * @param mpxx_rand_ansi_t構造体値
 * @return 発生した乱数
 */
 ...
 * @return 発生した乱数(大きさはMPXX_RAND_ANSI_MAX以下)
 */
 ...
 * @brief mpxx_rand_ansi()を拡張した、区間[0.0,1.0]の乱数発生処理本体
 * @return 発生した乱数値(大きさはMPXX_RAND_ANSI_MAX以下)
 */
